...
- *Frameworks and libraries*:
    * *Python*: django, starlette, sanic, flask, attrs, psycopg2, sqlalchemy, pytest
    * *Javascript*: **vanilla**, @yagni-js/yagni, @yagni-js/yagni-dom and others
    * *CSS*: PostCSS, LESS, SASS
- *Developer tools*: helix, vim, git, uv, ruff, ty
- *Assets management/building*: postcss, rollup, webpack, gulp, grunt
- *Infrastructure, deploy and monitoring*: nginx, uwsgi, gunicorn, supervisor, fabric, sentry, jenkins, ansible
- *Operating systems*: FreeBSD, Linux (VoidLinux, ArchLinux, AlpineLinux, Ubuntu, Gentoo, CentOS, RedHat)
...
- [Passware Inc.][passware], 2015-2025, Software Engineer
